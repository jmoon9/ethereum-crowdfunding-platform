...
let accounts;
let factory;    // reference to deployed instance of CampaignFactory
let campaignAddress;
let campaign;
...
describe('Campaigns', () => {
    ...
    it('handles new contributors', async () => {
    ...
    it('rejects a payment request if funds are unavailable', async () => {
        try{
            await campaign.methods.createRequest('Buy batteries','100', accounts[1])
            .send({
                from: accounts[0],
